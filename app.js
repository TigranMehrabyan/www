...
const db = {
    ...
    Promocodes: new Datastore({filename : 'database/promocodes.db'}),
    Promocodcategory: new Datastore({filename : 'database/promocodcategory.db'}),
    Productcategory: new Datastore({filename : 'database/productcategory.db'})
...
db.Promocodcategory.loadDatabase();

db.Productcategory.loadDatabase();

db.Promocodes.loadDatabase();
...
app.use(function(req, res, next) {
  ...
  //  }
    ...
    if (currLang !== 1 && currLang !== 2 && currLang !== 3) currLang = defaultLang;

    var langFile = ["ukraine","english","russian",][currLang-1];
